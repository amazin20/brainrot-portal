...
try{
 ...
 for(const [name,at,target]of [['room',[10,6.5,12],[-3,1,-3]],['blower',[-6,3.5,9],[-11.3,2,5]],['receiver',[-11,3.5,-.5],[-5.4,2.1,-5]],['door',[1,3,-5],[0,1.8,-12]]]){
 ...
 const result=await page.evaluate(async()=>{
  ...
  g.updateVisuals=function(...args){update.apply(this,args);const w=this.firstLevel.state.flywheel?.wheel;
   ...
   this.camera.position.set(-11,3.5,-.5);this.camera.lookAt(-5.4,2.1,-5);this.camera.updateMatrixWorld(true);render.call(this);
