...
export async function runRoom13(d,{order='cargo-first',interruptPower=false}={}){
 ...
 room13Access(d);
 walk(-16,-15.2);walk(-16,-12);walk(-12,-6);walk(-12,-2);walk(-14,3);walk(-10,3);walk(-10,.85);wait(.7);game.interact();mark('live weight turns the mirror');wait(1.8);check(s.optical.loaded,'Friend did not load the real mirror cradle');
