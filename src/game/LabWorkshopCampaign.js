...
const specs=[
 ['spring-mail','Пружинная почта','Гравитация и механическая защёлка','Высота падения сжимает настоящий пружинный поршень.',[32],['Друг может падать из потолочного портала. Пружина внизу принимает удар.','Обычный вес недостаточен: нужен разгон падением. Белое поле над поршнем — потолок. Если сам попал в чашу без удара, сервисная полоса отведёт стекло.','Свяжи пол загрузочной зоны с потолком над поршнем. Поставь друга на вход, дождись защёлки и забери его у сжатой пружины.']],
 ['freight-ferry','Телескопический док','Перевозка выдвижным пролётом','Кассета закреплена на берегу; узкий пролёт доставляет груз под защитный кожух.',[37],['Кассета неподвижна: выдвигается только узкий настил. Низкий кожух пропускает друга; над приёмником есть грузовой проём.','Приёмник отпирается весом друга, только когда пролёт полностью выдвинут. Друг может приехать на пролёте или попасть в закрытый док сверху.','Поднимись на левый берег и включи выдвижение. Либо отправь друга вместе с настилом, либо свяжи загрузочный пол с потолочной шахтой над приёмником. После срабатывания забери его с открывшегося берега.']],
