...
export class LabTileWorld extends StructuralWorld{
 ...
 surface(options){
  // Rooms 12–20 use the authored GLB wall/floor modules everywhere. The
  ...
  const highFidelity=this.highFidelity||(this.game.levelIndex>=11&&this.game.levelIndex<=19);
