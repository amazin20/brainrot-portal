...
export async function runRoom25(d,{order='weight-first',interruptLight=false}={}){
 ...
 walk(-7,-10);walk(-14,-10);walk(-14,-13);walk(-7,-13);walk(game.cargo.position.x-.9,game.cargo.position.z);pickup();walk(-3,-13);walk(10,-13);walk(10,-8.8);walk(12.5,-8.8);walk(16,-10);put(d,16,-10);aim(1,p['upper-relay'].getFrame().center);source(d,1);
