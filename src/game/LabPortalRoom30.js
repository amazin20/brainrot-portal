...
export function buildRoom30(game,index=29){
 ...
 k.bounds={minX:-42,maxX:170,minZ:-100,maxZ:75};k.ceiling=115;
 ...
 deck('Lower promenade and recovery garden',-42,170,-100,75,0);
 deck('Launch garden hub',-32,28,-22,26,52);
 ...
 deck('Sunward arrival island',123,158,2,42,28);
 ...
 w.box([94,46,-65],[1.1,92,80],w.materials.wall);
 ...
 const final=panel('sunward-outlet',[140,43,-68],[0,0,1],10,11,true);
 const lowerReturn=panel('lower-return',[-32,2.8,16],[1,0,0],6,5.6);
 const hubReturn=panel('hub-return',[-27,54.8,20],[1,0,0],6,5.6);
 ...
 k.wire([[48,40.1,23],[47,40.1,12],[47,39.8,-2],[94,39.8,-2],[110,39.8,-2],[110,43,-68],[140,43,-68]],()=>tilt.angle>.5);
