...
export function buildLabCampaignLevel(game,index){
 ...
 if(index===11)return upgradeBrowser3DArt(buildRoom12(game,index));
 if(index===12)return upgradeBrowser3DArt(finishAdvancedRoom(buildRoom13(game,index)));
 if(index===13)return upgradeBrowser3DArt(finishAdvancedRoom(buildRoom14(game,index)));
 if(index===14)return upgradeBrowser3DArt(finishAdvancedRoom(buildRoom15(game,index)));
